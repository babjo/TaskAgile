        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-group">
            ...
            <div class="field-error" v-if="$v.form.username.$dirty">
              ...
              <div class="error" v-if="!$v.form.username.alphaNum">Username can only contain letters and
                numbers
              </div>
              <div class="error" v-if="!$v.form.username.minLength">Username must have at least
                {{ $v.form.username.$params.minLength.min }} letters.
              </div>
              <div class="error" v-if="!$v.form.username.maxLength">Username is too long. It can contains
                maximum {{ $v.form.username.$params.maxLength.max }} letters.
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="field-error" v-if="$v.form.emailAddress.$dirty">
              ...
              <div class="error" v-if="!$v.form.emailAddress.maxLength">Email address is too long. It can
                contains maximum {{ $v.form.emailAddress.$params.maxLength.max }} letters.
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="field-error" v-if="$v.form.password.$dirty">
              ...
              <div class="error" v-if="!$v.form.password.minLength">Password is too short. It can contains at
                least {{ $v.form.password.$params.minLength.min }} letters.
              </div>
              <div class="error" v-if="!$v.form.password.maxLength">Password is too long. It can contains
                maximium {{ $v.form.password.$params.maxLength.max }} letters.
              </div>
            </div>
          </div>
