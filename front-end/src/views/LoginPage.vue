    ...
    <div class="row justify-content-center">
      <div class="form">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="links">
            <p class="sign-up text-muted">{{ $t('loginPage.form.noAccountYet') }}<a href="/register" class="link-sign-up">{{ $t('loginPage.form.signUpHere') }}</a></p>
            <p><a href="#">{{ $t('loginPage.form.forgotPassword') }}</a></p>
          </div>
        </form>
      </div>
    </div>
